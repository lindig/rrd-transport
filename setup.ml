...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56492dd2dece7d15583b536de32960bc) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_unit", []))];
          ...
          ("test_scale_v1",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_scale", ["-p"; "1"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_scale_v2",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_scale", ["-p"; "2"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xcp.rrd_ppx", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "rrd-transport";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "reader.ml"});
               Executable
                 ({
                     cs_name = "rrdwriter";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "writer.ml"});
               Executable
                 ({
                     cs_name = "test_unit";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_unit.ml"});
               Test
                 ({
                     cs_name = "test_unit";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_scale.ml"});
               Test
                 ({
                     cs_name = "test_scale_v1";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\r\169m\242\189bs\224t;o\017X /\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
